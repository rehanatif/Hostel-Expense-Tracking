...
<head>
    ...
    <link rel="stylesheet" href="{{ $path }}assets/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ $path }}assets/vendor/css/rtl/theme-default.css" class="template-customizer-theme-css" />

    <link rel="stylesheet" href="{{ $path }}assets/css/demo.css" />

    <link rel="stylesheet" href="{{ $path }}assets/vendor/css/pages/front-page.css" />
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ $path }}assets/vendor/libs/node-waves/node-waves.css" />

    <link rel="stylesheet" href="{{ $path }}assets/vendor/libs/nouislider/nouislider.css" />
    <link rel="stylesheet" href="{{ $path }}assets/vendor/libs/swiper/swiper.css" />

    <!-- Page CSS -->

    <link rel="stylesheet" href="{{ $path }}assets/vendor/css/pages/front-page-landing.css" />
    ...
    <script src="{{ $path }}assets/vendor/js/template-customizer.js"></script>

    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script src="{{ $path }}assets/js/front-config.js"></script>
</head>

<body>
    <script src="{{ $path }}assets/vendor/js/dropdown-hover.js"></script>
    <script src="{{ $path }}assets/vendor/js/mega-dropdown.js"></script>
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-lg-4 d-none d-lg-block">
                                        <div class="bg-body nav-img-col p-2">
                                            <img
                                                src="{{ $path }}assets/img/front-pages/misc/nav-item-col-img.png"
    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
        ...
        <section id="hero-animation">
            <div id="landingHero" class="section-py landing-hero position-relative">
                <img
                    src="{{ $path }}assets/img/front-pages/backgrounds/hero-bg.png"
                    alt="hero background"
                    ...
                    <div class="hero-text-box text-center position-relative">
                        ...
                        <div class="landing-hero-btn d-inline-block position-relative">
                            <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium">Join community
                                <img
                                    src="{{ $path }}assets/img/front-pages/icons/Join-community-arrow.png"
                    ...
                    <div id="heroDashboardAnimation" class="hero-animation-img">
                        <a href="../vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
                            <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                                <img
                                    src="{{ $path }}assets/img/front-pages/landing-page/hero-dashboard-light.png"
                                    alt="hero dashboard"
                                    class="animation-img"
                                    data-app-light-img="front-pages/landing-page/hero-dashboard-light.png"
                                    data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png" />
                                <img
                                    src="{{ $path }}assets/img/front-pages/landing-page/hero-elements-light.png"
                                    alt="hero elements"
            ...
            <div class="container">
                ...
                <h4 class="text-center mb-1">
                    <span class="position-relative fw-extrabold z-1">Everything you need
                        <img
                            src="{{ $path }}assets/img/front-pages/icons/section-title-icon.png"
                            alt="laptop charging"
                ...
                <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ $path }}assets/img/front-pages/icons/laptop.png" alt="laptop charging" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ $path }}assets/img/front-pages/icons/rocket.png" alt="transition up" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ $path }}assets/img/front-pages/icons/paper.png" alt="edit" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ $path }}assets/img/front-pages/icons/check.png" alt="3d select solid" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ $path }}assets/img/front-pages/icons/user.png" alt="lifebelt" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ $path }}assets/img/front-pages/icons/keyboard.png" alt="google docs" />
                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img
                                                        src="{{ $path }}assets/img/front-pages/branding/logo-1.png"
                                                        alt="client logo"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="{{ $path }}assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img
                                                        src="{{ $path }}assets/img/front-pages/branding/logo-2.png"
                                                        alt="client logo"
                                                        class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="{{ $path }}assets/img/avatars/2.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img
                                                        src="{{ $path }}assets/img/front-pages/branding/logo-3.png"
                                                        alt="client logo"
                                                        class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="{{ $path }}assets/img/avatars/3.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img
                                                        src="{{ $path }}assets/img/front-pages/branding/logo-4.png"
                                                        alt="client logo"
                                                        class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="{{ $path }}assets/img/avatars/4.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img
                                                        src="{{ $path }}assets/img/front-pages/branding/logo-5.png"
                                                        alt="client logo"
                                                        class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="{{ $path }}assets/img/avatars/5.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0">Eugenia Moore</h6>
                                                        <p class="small text-muted mb-0">Founder of Hubspot</p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img
                                                        src="{{ $path }}assets/img/front-pages/branding/logo-6.png"
                                                        alt="client logo"
                                                        class="client-logo img-fluid" />
                                                </div>
                                                <p>
                ...
                <div class="swiper-logo-carousel py-8">
                    <div class="swiper" id="swiper-clients-logos">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img
                                    src="{{ $path }}assets/img/front-pages/branding/logo_1-light.png"
                                    alt="client logo"
                                    class="client-logo"
                            ...
                            <div class="swiper-slide">
                                <img
                                    src="{{ $path }}assets/img/front-pages/branding/logo_2-light.png"
                                    alt="client logo"
                                    class="client-logo"
                            ...
                            <div class="swiper-slide">
                                <img
                                    src="{{ $path }}assets/img/front-pages/branding/logo_3-light.png"
                                    alt="client logo"
                                    class="client-logo"
                            ...
                            <div class="swiper-slide">
                                <img
                                    src="{{ $path }}assets/img/front-pages/branding/logo_4-light.png"
                                    alt="client logo"
                                    class="client-logo"
                            ...
                            <div class="swiper-slide">
                                <img
                                    src="{{ $path }}assets/img/front-pages/branding/logo_5-light.png"
                                    alt="client logo"
                                    class="client-logo"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img
                                    src="{{ $path }}assets/img/front-pages/landing-page/team-member-1.png"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div class="bg-label-info border border-bottom-0 border-label-info position-relative team-image-box">
                                <img
                                    src="{{ $path }}assets/img/front-pages/landing-page/team-member-2.png"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img
                                    src="{{ $path }}assets/img/front-pages/landing-page/team-member-3.png"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img
                                    src="{{ $path }}assets/img/front-pages/landing-page/team-member-4.png"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                ...
                <div class="text-center mb-12">
                    <div class="position-relative d-inline-block pt-3 pt-md-0">
                        ...
                        <div class="pricing-plans-item position-absolute d-flex">
                            <img
                                src="{{ $path }}assets/img/front-pages/icons/pricing-plans-arrow.png"
                ...
                <div class="row g-6 pt-lg-5">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="text-center">
                                    <img
                                        src="{{ $path }}assets/img/front-pages/icons/paper-airplane.png"
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card border border-primary shadow-xl">
                            <div class="card-header">
                                <div class="text-center">
                                    <img src="{{ $path }}assets/img/front-pages/icons/plane.png" alt="plane icon" class="mb-8 pb-2" />
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="text-center">
                                    <img
                                        src="{{ $path }}assets/img/front-pages/icons/shuttle-rocket.png"
                ...
                <div class="row gy-6">
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-primary shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ $path }}assets/img/front-pages/icons/laptop.png" alt="laptop" class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-success shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ $path }}assets/img/front-pages/icons/user-success.png" alt="laptop" class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-info shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ $path }}assets/img/front-pages/icons/diamond-info.png" alt="laptop" class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-warning shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ $path }}assets/img/front-pages/icons/check-warning.png" alt="laptop" class="mb-4" />
            ...
            <div class="container">
                ...
                <div class="row gy-12 align-items-center">
                    <div class="col-lg-5">
                        <div class="text-center">
                            <img
                                src="{{ $path }}assets/img/front-pages/landing-page/faq-boy-with-logos.png"
        ...
        <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
            <img
                src="{{ $path }}assets/img/front-pages/backgrounds/cta-bg-light.png"
            ...
            <div class="container">
                <div class="row align-items-center gy-12">
                    ...
                    <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
                        <img
                            src="{{ $path }}assets/img/front-pages/landing-page/cta-dashboard.png"
                            alt="cta dashboard"
                ...
                <div class="row g-6">
                    <div class="col-lg-5">
                        <div class="contact-img-box position-relative border p-2 h-100">
                            <img
                                src="{{ $path }}assets/img/front-pages/icons/contact-border.png"
                                alt="contact border"
                                class="contact-border-img position-absolute d-none d-lg-block scaleX-n1-rtl" />
                            <img
                                src="{{ $path }}assets/img/front-pages/landing-page/contact-customer-service.png"
    ...
    <footer class="landing-footer bg-body footer-text">
        <div class="footer-top position-relative overflow-hidden z-1">
            <img
                src="{{ $path }}assets/img/front-pages/backgrounds/footer-bg-light.png"
                alt="footer bg"
            ...
            <div class="container">
                <div class="row gx-0 gy-6 g-lg-10">
                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <a href="javascript:void(0);" class="d-block mb-4"><img src="{{ $path }}assets/img/front-pages/landing-page/apple-icon.png" alt="apple icon" /></a>
                        <a href="javascript:void(0);" class="d-block"><img src="{{ $path }}assets/img/front-pages/landing-page/google-play-icon.png" alt="google play icon" /></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div
                ...
                <div>
                    <a href="https://github.com/pixinvent" class="me-3" target="_blank">
                        <img src="{{ $path }}assets/img/front-pages/icons/github.svg" alt="github icon" />
                    </a>
                    <a href="https://www.facebook.com/pixinvents/" class="me-3" target="_blank">
                        <img src="{{ $path }}assets/img/front-pages/icons/facebook.svg" alt="facebook icon" />
                    </a>
                    <a href="https://twitter.com/pixinvents" class="me-3" target="_blank">
                        <img src="{{ $path }}assets/img/front-pages/icons/twitter.svg" alt="twitter icon" />
                    </a>
                    <a href="https://www.instagram.com/pixinvents/" target="_blank">
                        <img src="{{ $path }}assets/img/front-pages/icons/instagram.svg" alt="google icon" />
                    </a>
                </div>
            </div>
        </div>
    ...
    <!-- Vendors JS -->
    <script src="{{ $path }}assets/vendor/libs/nouislider/nouislider.js"></script>
    <script src="{{ $path }}assets/vendor/libs/swiper/swiper.js"></script>

    <!-- Main JS -->
    <script src="{{ $path }}assets/js/front-main.js"></script>

    <!-- Page JS -->
    <script src="{{ $path }}assets/js/front-page-landing.js"></script>
</body>
